 ...
 */
const cdn_providers = {
    // cdnjs: 'https://cdnjs.cloudflare.com/ajax/libs/${ package }/${ version }/${ filename }', //Wayne for speed
...
const font_providers = {
    // google: 'https://fonts.googleapis.com/${ type }?family=${ fontname }' //Wayne for speed
    google: 'https://fonts.loli.net/${ type }?family=${ fontname }'
};

const icon_providers = {
    // fontawesome: 'https://use.fontawesome.com/releases/v5.4.1/css/all.css'  //Wayne for speed
